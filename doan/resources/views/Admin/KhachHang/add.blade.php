      ...
      <section class="content">
          <div class="container-fluid">
              <div class="card card-primary">
                  ...
                  @include('error.error')
                  <div class="card-body">
                      <form action="{{ route('adminkhachhang.store') }}" method="post" enctype="multipart/form-data">
                          @csrf
                          <div  class="mb-3 mt-3">
                            <label  for="IntroCar">Tên Khách Hàng:</label>
                            <input type="text"  class="form-control"  name="txtTenKhachHang">
                          </div>
                          <div class="mb-3">
                            <label  for="PriceOld">Căn Cước Công Dân</label>
                            <input type="text" class="form-control" id="old"  name="txtCCCD">
                          </div>
                          <div class="mb-3">
                              <label for="PriceSale">Số Điện Thoại</label>
                              <input type="text" class="form-control"  name="txtSĐT">
                          </div>
                          <div class="mb-3">
